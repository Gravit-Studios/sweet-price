    ...
    <div class="mobile-drawer-overlay ${state.mobileMenuOpen ? 'open' : ''}">
      <nav class="mobile-drawer">
        <div class="mobile-drawer-header">
          <span class="brand"><img src="/assets/logotipo/Doce-Preco-Logo-Navbar.svg" alt="Doce Preço" class="brand-logo" /></span>
      ...
      <header class="navbar">
        <div class="navbar-inner">
          <button type="button" class="brand" data-action="goto" data-route="inicio">
            <img src="/assets/logotipo/Doce-Preco-Logo-Navbar.svg" alt="Doce Preço" class="brand-logo" />
          </button>
  ...
  return `
    <div class="auth-page">
      <div class="auth-form-side">
        <button type="button" class="auth-brand" data-action="goto" data-route="inicio"><img src="/assets/logotipo/Doce-Preco-Logo-Navbar.svg" alt="Doce Preço" class="brand-logo" /></button>
